...
const routes = [
  ...
  },
  {
    path: '/my',
    name: 'PersonalCenter',
    component: () => import(/* webpackChunkName: "PersonalCenter" */ '../views/personal/PersonalCenter')
  },
  {
    path: '/login',
    name: 'LoginView',
  ...
  },
  {
    path: '/order',
    name: 'OrderView',
    component: () => import(/* webpackChunkName: "OrderView" */ '../views/order/Order')
  },
  {
    path: '/orderComfirm/:id',
    name: 'OrderComfirm',
    component: () => import(/* webpackChunkName: "OrderComfirm" */ '../views/order/OrderComfirm')
  }
  // {
  //   path: '/about',
  //   name: 'about',
